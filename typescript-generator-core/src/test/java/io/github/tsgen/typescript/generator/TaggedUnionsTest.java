...
public class TaggedUnionsTest {
    ...
    public void testIdClass() {
        ...
        final String expected = (
                "\n" +
                "interface Car {\n" +
                "    '@class': 'io.github.tsgen.typescript.generator.TaggedUnionsTest$DieselCar' | 'io.github.tsgen.typescript.generator.TaggedUnionsTest$ElectricCar';\n" +
                "    name: string;\n" +
                "}\n" +
                "\n" +
                "interface DieselCar extends Car {\n" +
                "    '@class': 'io.github.tsgen.typescript.generator.TaggedUnionsTest$DieselCar';\n" +
                "    fuelTankCapacityInLiters: number;\n" +
                "}\n" +
                "\n" +
                "interface ElectricCar extends Car {\n" +
                "    '@class': 'io.github.tsgen.typescript.generator.TaggedUnionsTest$ElectricCar';\n" +
    ...
    public void testGenericBaseWithNonGenericSubType() {
        ...
        Assertions.assertTrue(output.contains("type EntityUnion<T> = io.github.tsgen.typescript.generator.TaggedUnionsTest.Foo | io.github.tsgen.typescript.generator.TaggedUnionsTest.Bar"));
    }
