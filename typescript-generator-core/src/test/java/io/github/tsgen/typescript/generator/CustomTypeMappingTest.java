...
//        System.out.println(json);
        ...
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.CustomTypeMappingTest$MyEnum", "{ code: string, definition: string }");
    ...
    public void testSuperTypeString() throws Exception {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.CustomTypeMappingTest$BaseCustomMapping", "string");
    ...
    public void testGenericClassWithCustomMapping() {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.CustomTypeMappingTest$GenericClass<D>", "CustomGenericClass<D>");
