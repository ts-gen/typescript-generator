...
public class GenericCustomTypeMappingsTest {
    ...
    public void testGenericMappingToString() {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.GenericCustomTypeMappingsTest$IdRepresentation<T>", "string");
    ...
    public void testGenerics() {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.GenericCustomTypeMappingsTest$Generic2<T1, T2>", "Test<T2, T1>");
    ...
    public void testUnwrap() {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.GenericCustomTypeMappingsTest$Generic2<T1, T2>", "T2");
        final String output = new TypeScriptGenerator(settings).generateTypeScript(Input.from(Usage.class));
    ...
    public void testMapStringString() {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.GenericCustomTypeMappingsTest$NonGeneric", "Map<string, string>");
    ...
    public void testAlternativeSyntaxWithArray() {
        final Settings settings = TestUtils.settings();
        settings.customTypeMappings = Collections.singletonMap("io.github.tsgen.typescript.generator.GenericCustomTypeMappingsTest$Generic2[T1, T2]", "string[]");
        final String output = new TypeScriptGenerator(settings).generateTypeScript(Input.from(Usage.class));
