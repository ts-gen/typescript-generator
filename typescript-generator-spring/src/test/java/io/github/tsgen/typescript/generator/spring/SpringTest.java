...
public class SpringTest {
    ...
    public void testUnwrapping() {
        ...
        settings.outputFileType = TypeScriptFileType.implementationFile;
        settings.generateSpringApplicationClient = true;
        settings.customTypeMappings.put("io.github.tsgen.typescript.generator.spring.SpringTest$Wrapper<T>", "Unwrap<T>");
    ...
    public void testUnwrappingNew() {
        ...
        settings.outputFileType = TypeScriptFileType.implementationFile;
        settings.generateSpringApplicationClient = true;
        settings.customTypeMappings.put("io.github.tsgen.typescript.generator.spring.SpringTest$Wrapper<T>", "T");
        final String output = new TypeScriptGenerator(settings).generateTypeScript(Input.from(ControllerWithWrapper.class));
